...
export default {
  ...
  */
  head: {
    title: 'IATI Funding Dashboard (Ukraine 2022 data)',
    meta: [
      { charset: 'utf-8' },
      ...
      { name: 'twitter:title', content: 'IATI Funding Dashboard (Ukraine 2022 data)' },
      ...
      { name: 'twitter:image:alt', content: 'Contributions to Ukraine finance data.' }
    ],
    link: [
